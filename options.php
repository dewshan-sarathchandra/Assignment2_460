...
$options = get_option( 'abcsushi_options_settings' );
?>
<input type="radio" name="abcsushi_options_settings[abcsushi_radio_field]" <?php if (isset($options['abcsushi_radio_field'])) checked( $options['cd_radio_field'], 1 ); ?> value="1" /> <label>Choice One</label><br />
<input type="radio" name="abcsushi_options_settings[cd_radio_field]" <?php if (isset($options['cd_radio_field'])) checked( $options['abcsushi_radio_field'], 2 ); ?> value="2" /> <label>Choice Two</label><br />
<input type="radio" name="abcsushi_options_settings[cd_radio_field]" <?php if (isset($options['abcsushi_radio_field'])) checked( $options['abcsushi_radio_field'], 3 ); ?> value="3" /> <label>Choice Three</label>
<?php
}
...
$options = get_option( 'abcsushi_options_settings' );
?>
<textarea cols="40" rows="5" name="abcsushi_options_settings[cd_textarea_field]"><?php
...
<form action="options.php" method="post"> <h2>Abc Sushi's Options Page</h2> <?php
